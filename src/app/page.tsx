...
const users = await getUsers();
    ...
    return (
        <main className='flex h-screen flex-col items-center justify-center p-4 md:px-24 py-32 gap-4'>
            ...
            <div className='z-10 border rounded-lg max-w-5xl w-full min-h-[85vh] text-sm lg:flex dark:text-white'>
                <ChatLayout defaultLayout={defaultLayout} users={users} /> {/* Render ChatLayout with default layout */}
            </div>
        </main>
    );
}
